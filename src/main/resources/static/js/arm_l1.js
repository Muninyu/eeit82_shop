...
const exercises = [
	{
		name: "手臂上舉",
		gif: "/img/sportimg/手/gif/手臂上舉.gif",
		description: "30秒",
	...
	{
		name: "休息時間",
		gif: "/img/sportimg/relax.jpg", // 你可以使用一個休息的圖片或GIF
	...
	{
		name: "雙臂側舉",
		gif: "/img/sportimg/手/gif/雙臂側舉.gif",
		description: "30秒",
		duration: 30, // 休息時間，單位為秒
		met: 2.5,
		type: "time", // 基於時間的動作
	...
	{
		name: "三頭肌撐體",
		gif: "/img/sportimg/手/gif/三頭肌撐體.gif",
		description: "X 10",
		reps: 10,
		met: 3.5,
		type: "reps", // 基於時間的動作
	...
	{
		name: "手臂環繞(順)",
		gif: "/img/sportimg/手/gif/手臂環繞(順).gif",
		description: "30秒",
		duration: 30, // 休息時間，單位為秒
		met: 2.5,
		type: "time", // 基於時間的動作
	...
	{
		name: "手臂環繞(逆)",
		gif: "/img/sportimg/手/gif/手臂環繞(逆).gif",
		description: "30秒",
		duration: 30, // 休息時間，單位為秒
		met: 2.5,
		type: "time", // 基於時間的動作
	...
	{
		name: "鑽石俯臥撐",
		gif: "/img/sportimg/胸/gif/鑽石俯臥撐.gif",
		description: "X 6",
		reps: 6,
		met: 4.5,
		type: "reps", // 基於時間的動作
	...
	{
		name: "胸前雙臂對壓",
		gif: "/img/sportimg/手/gif/胸前雙臂對壓.gif",
		description: "15秒",
	...
	{
		name: "對角線式平板支撐",
		gif: "/img/sportimg/手/gif/對角線式平板支撐.gif",
		description: "X 10",
		reps: 10,
		met: 4,
		type: "reps", // 基於時間的動作
	...
	{
		name: "俯臥撐",
		gif: "/img/sportimg/胸/gif/俯臥撐.gif",
		description: "X 10",
		reps: 10,
		met: 4,
		type: "reps", // 基於時間的動作
	...
	{
		name: "推牆俯臥撐",
		gif: "/img/sportimg/手/gif/推牆俯臥撐.gif",
		description: "X 12",
		reps: 12,
		met: 2.5,
		type: "reps", // 基於時間的動作
	...
	{
		name: "手臂拉伸",
		gif: "/img/sportimg/手/gif/手臂伸展.gif",
		description: "120秒",
		duration: 120,
		met: 2,
		type: "time", // 基於時間的動作
