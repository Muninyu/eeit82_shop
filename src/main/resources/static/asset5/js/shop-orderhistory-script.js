...
$(".accordiontitle").parent().children(".accordioncontext").slideUp();

$(".accordion").each(function() {
    var accordionItem = $(this).children(".accordiontitle");
    accordionItem.each(function() {
        function accordionf(e) {
            $(this).next(".accordioncontext").slideToggle();
            $(this).parent().siblings().children(".accordioncontext").slideUp();
            e.preventDefault();
        }
        $(this).click(accordionf);
        $(this).keyup(accordionf);
    });
});